...
component {
	...
	// Module Properties
	this.title 				= "customModule2";
	this.author 			= "Gavin Pickin";
	this.webURL 			= "http://www.gpickin.com";
	this.description 		= "Custom Module 2";
	this.version			= "1.2.3";
	...
	// Module Entry Point
	this.entryPoint			= "customModule2";
	// Inherit Entry Point
	this.inheritEntryPoint 	= false;
	// Model Namespace
	this.modelNamespace		= "customModuleName";
	// CF Mapping
	this.cfmapping			= "customModule2Mapping";
	// Auto-map models

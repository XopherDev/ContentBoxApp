...
//fileAppend("c:\temp2\cc.txt", "I'm in (page.cfm):  #chr(10)##chr(13)#");
</cfscript>

<!---
<cfif rc.pageSlug is not "log-me-in">
<cfset session._mysecURL = "#rc.pageSlug#" />
</cfif>
<cfdump var="#session#" />
--->
<!---
<cfdump var="#prc.cbSettings.cb_security_login_signout_url#" />
<cfdump var="#event.getCurrentHandler()#" />
<cfdump var="#prc#" />
--->
	...
	<div class="container">
		...
		<div class="col-sm-#variables.span#">
			...
			<section id="comments">
				...
				<div id="stuff"> <!--- woot added by ct --->
					[[[[ #cb.quickCustomFields()# ]]]]
